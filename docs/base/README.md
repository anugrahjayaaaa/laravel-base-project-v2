...
|| # | Category | Purpose |
|---|----------|---------|
|| 1 | [Architecture](../base/architecture/principles.md) | Core principles, boundaries, conventions, ADRs, components |
||| 2 | [Dependencies](../base/dependencies/overview.md) | Package inventory, matrix, governance, per-package ADRs. Governance: [dependency-governance.md](../base/governance/dependency-governance.md) |
||| 3 | [Security](../base/security/security-baseline.md) | Auth, sessions, rate limiting, web security, data protection |
...
||| 10 | [UI](../base/ui/ui-architecture.md) | UI architecture, [design-system.md](ui/design-system.md), [ui-authorization.md](ui/ui-authorization.md), [ui-adminlte-setup.md](ui/ui-adminlte-setup.md) |
