    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header users-navbar border-bottom border-2 border-bottom-primary pt-3 pb-2 px-3">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                <ul class="nav nav-borders gap-2 p-0 m-0"
                    style="list-style:none; display:flex; gap:0.5rem; flex-wrap:nowrap; overflow-x:auto;">
                    <li class="nav-item">
                        <a class="nav-link {{ $tabClass('active') }} px-3 py-2" href="{{ $tabUrl('active') }}"
                            ...
                            Active Users <span
                                class="badge bg-primary text-white ms-1 rounded-pill">{{ $counts['active'] }}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ $tabClass('inactive') }} px-3 py-2" href="{{ $tabUrl('inactive') }}"
                            ...
                            Inactive <span
                                class="badge bg-light text-dark border ms-1 rounded-pill">{{ $counts['inactive'] }}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ $tabClass('locked') }} px-3 py-2" href="{{ $tabUrl('locked') }}"
                            ...
                            Locked <span
                                class="badge bg-light text-dark border ms-1 rounded-pill">{{ $counts['locked'] }}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ $tabClass('trashed') }} px-3 py-2" href="{{ $tabUrl('trashed') }}"
                            ...
                            Trash <span
                                class="badge bg-light text-dark border ms-1 rounded-pill">{{ $counts['trashed'] }}</span>
                        </a>
                    </li>
                </ul>
